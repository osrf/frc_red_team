#include <iostream>
#include "JoyToJointsLoader.hh"

using namespace gazebo;

GZ_REGISTER_MODEL_PLUGIN(JoyToJointsLoader)

/////////////////////////////////////////////////
JoyToJointsLoader::JoyToJointsLoader()
{
}
...
/////////////////////////////////////////////////
void JoyToJointsLoader::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  this->model = _model;
  ...
  auto subOpts = ros::SubscribeOptions::create<sensor_msgs::Joy>("/red_team/loader_robot/joy", 1,
              boost::bind(&JoyToJointsLoader::OnJoy, this, _1),
              ros::VoidPtr(), &this->callbackQueue);

  this->joySub = this->gazeboRos->node()->subscribe(subOpts);

  this->callbackQueueThread =
      std::thread(std::bind(&JoyToJointsLoader::QueueThread, this));

  this->alive = true;
}

/////////////////////////////////////////////////
void JoyToJointsLoader::OnJoy(const sensor_msgs::Joy::ConstPtr &_msg)
{
...
/////////////////////////////////////////////////
void JoyToJointsLoader::QueueThread()
{
